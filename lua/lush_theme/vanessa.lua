...
local theme = lush(function()
  return {
    ...
    Pmenu        { bg = "#181818" }, -- Popup menu: Normal item.
    PmenuSel     { bg = "#d88bef", fg = "#000000" }, -- Popup menu: Selected item.
	CmpItemMenu      { fg = "#f564c5", bg = "#181818"},
	CmpItemMenuSel   { bg = "#181818", fg = "#181818"},
    ...
    CmpItemKindText          { fg = "#f0cb67", bg = "#181818", gui = "italic" },
    CmpItemKindMethod        { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindFunction      { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindConstructor   { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindField         { fg = "#f56464", bg = "#181818", gui = "italic" },
    CmpItemKindVariable      { fg = "#a8d16f", bg = "#181818", gui = "italic" },
    CmpItemKindClass         { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindInterface     { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindModule        { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindProperty      { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindUnit          { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindValue         { fg = "#67a7f0", bg = "#181818", gui = "italic" },
    CmpItemKindEnum          { fg = "#9966cc", bg = "#181818", gui = "italic" },
    CmpItemKindKeyword       { fg = "#d067f0", bg = "#181818", gui = "italic" },
    CmpItemKindSnippet       { fg = "#d88bef", bg = "#181818", gui = "italic" },
    CmpItemKindColor         { fg = "#f56464", bg = "#181818", gui = "italic" },
    CmpItemKindFile          { fg = "#f0cb67", bg = "#181818", gui = "italic" },
    CmpItemKindReference     { fg = "#f56464", bg = "#181818", gui = "italic" },
    CmpItemKindFolder        { fg = "#f0cb67", bg = "#181818", gui = "italic" },
    CmpItemKindEnumMember    { fg = "#9966cc", bg = "#181818", gui = "italic" },
    CmpItemKindConstant      { fg = "#9966cc", bg = "#181818", gui = "italic" },
    CmpItemKindStruct        { fg = "#f564c5", bg = "#181818", gui = "italic" },
    CmpItemKindEvent         { fg = "#d88bef", bg = "#181818", gui = "italic" },
    CmpItemKindOperator      { fg = "#d88bef", bg = "#181818", gui = "italic" },
    CmpItemKindTypeParameter { fg = "#f564c5", bg = "#181818", gui = "italic" },

    -- CmpItemKindText          { bg = "#f0cb67", fg = "#000000" },
    -- CmpItemKindMethod        { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindFunction      { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindConstructor   { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindField         { bg = "#f56464", fg = "#000000" },
    -- CmpItemKindVariable      { bg = "#a8d16f", fg = "#000000" },
    -- CmpItemKindClass         { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindInterface     { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindModule        { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindProperty      { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindUnit          { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindValue         { bg = "#67a7f0", fg = "#000000" },
    -- CmpItemKindEnum          { bg = "#9966cc", fg = "#000000" },
    -- CmpItemKindKeyword       { bg = "#d067f0", fg = "#000000" },
    -- CmpItemKindSnippet       { PmenuSel },
    -- CmpItemKindColor         { bg = "#f56464", fg = "#000000" },
    -- CmpItemKindFile          { bg = "#f0cb67", fg = "#000000" },
    -- CmpItemKindReference     { bg = "#f56464", fg = "#000000" },
    -- CmpItemKindFolder        { bg = "#f0cb67", fg = "#000000" },
    -- CmpItemKindEnumMember    { bg = "#9966cc", fg = "#000000" },
    -- CmpItemKindConstant      { bg = "#9966cc", fg = "#000000" },
    -- CmpItemKindStruct        { bg = "#f564c5", fg = "#000000" },
